...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" AssociatedControlID="password" CssClass="col-md-3 control-label">Password</asp:Label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server" AssociatedControlID="confirmPassword" CssClass="col-md-3 control-label" Style="white-space: nowrap">Confirm password</asp:Label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    <asp:Button ID="Button1" runat="server" Text="Set Password" ValidationGroup="SetPassword" OnClick="SetPassword_Click" CssClass="btn btn-primary" />
                                </div>
                            </div>
                        </div>
                    </asp:PlaceHolder>
            ...
            <div class="col-md-4">
                <section id="externalLoginsForm">
                    <asp:ListView ID="ListView1" runat="server"
                        ...
                        <LayoutTemplate>
                            <h4 class="pgtitle">Registered Logins</h4>
                            <table class="table">
                                <tbody>
    ...
    <script type="text/javascript">
        ...
        {
            $("#divMain1").css('min-height', $(window).height() - 104 - ($(".header-panel").height() + $(".footer-panel").height()));
        });
    </script>
</asp:Content>
