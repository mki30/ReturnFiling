<%@ Page Language="C#" Title="Password Recover | return-filing.in" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" EnableViewState="false" CodeFile="~/Account/PasswordRecover.aspx.cs" Inherits="Account_PasswordRecover" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            $("#divMain1").css('min-height', $(window).height() - 88 - ($(".header-panel").height() + $(".footer-panel").height()));
        });
