    ...
    <div class="container" id="divMain">
        ...
        <div class="col-md-6" >
            <div class="form-horizontal" role="form">
              <%--  <h2><%: Title %>.</h2>--%>
                <h4 class="pgtitle">Create a new account.</h4>
                <hr />
                <%--    <asp:ValidationSummary runat="server" CssClass="text-danger" />--%>
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" AssociatedControlID="UserName" CssClass="col-md-3 control-label">Email ID</asp:Label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <asp:Label ID="Label2" runat="server" AssociatedControlID="Password" CssClass="col-md-3 control-label">Password</asp:Label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <asp:Label ID="Label3" runat="server" AssociatedControlID="ConfirmPassword" CssClass="col-md-3 control-label">Confirm password</asp:Label>
                    <div class="col-md-9">
