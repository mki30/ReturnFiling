...
public class Cmn
{
	...
	public static void SaveInCookie(string key, string value)
	{
	...
	public static string LoadFromCookie(string key, string Defaultvalue = "")
	{
    ...
    {
        //Create URL Slug(e.g. kapil-rra-soft)
